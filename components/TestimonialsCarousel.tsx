...
const testimonials: Testimonial[] = [
  {
    ...
    content: 'Rosalind completely transformed my son\'s confidence with Maths. He went from dreading lessons to actually enjoying them!',
    rating: 5,
  },
  {
    id: 2,
    ...
    content: 'The multi-sensory approach helped our daughter with dyslexia make real progress in reading. Highly recommended.',
    rating: 5,
  },
  {
    id: 3,
    ...
    content: 'Rosalind\'s SATs preparation was invaluable. My child felt prepared and confident going into the exams.',
    rating: 5,
  },
  {
    id: 4,
    ...
    content: 'Patient, knowledgeable, and genuinely cares about each child\'s individual needs. We couldn\'t ask for more.',
    rating: 5,
  },
];
